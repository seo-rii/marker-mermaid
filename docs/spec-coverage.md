...
| OCR recall | 구현 | bounded occurrence multisets, spatial/bbox-less dedup, structural/Gantt plus Class·ER·Timeline serializer-visible labels, invalid/over-budget review gate |
