...
| structured operations | 구현 | provenance-backed edge 추가, exact-ID edge 재연결·삭제, node 삭제/group 생성, screen-space endpoint drag와 accessible forms, global IR↔Mermaid node/edge/group 1:1 gate, pre-interpretation optimistic lock |
